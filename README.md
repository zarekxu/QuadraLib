...
Currently, we only support hybrid back-propagation for quadratic fully connected layers (check [here](https://github.com/zarekxu/QuadraLib/blob/main/image_classification/models/quadratic_layer.py)), the quadratic convolutional layer version will be released soon. 
